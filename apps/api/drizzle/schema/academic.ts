...
export const academicTerms = academicSchema.table(
  'academic_terms',
  {
    ...
    /** Date the system auto-creates the enrollment billing snapshot (formerly census lock date). */
    censusSnapshotDate: date('census_snapshot_date'),
    ...
    adjustmentWindowEndsAt: timestamp('adjustment_window_ends_at', { withTimezone: true }),
    closedAt: timestamp('closed_at', { withTimezone: true }),
    closedById: uuid('closed_by_id'),
