              ...
              <FormItem>
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-1 top-1/2 flex size-11 -translate-y-1/2 items-center justify-center rounded-lg text-neutral-500 transition-colors hover:text-neutral-300 sm:right-3 sm:size-auto"
