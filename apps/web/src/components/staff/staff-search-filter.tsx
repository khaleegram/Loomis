...
import type { StaffStatusFilter } from '@/components/staff/staff-directory-table';
...
interface FilterChip {
  key: StaffStatusFilter | 'role-teacher' | 'role-admin' | 'role-finance';
  label: string;
  statusKey?: StaffStatusFilter;
}

const FILTER_CHIPS: FilterChip[] = [
  { key: 'all', label: 'All Staff', statusKey: 'all' },
  { key: 'active', label: 'Active', statusKey: 'active' },
  { key: 'pending', label: 'Pending', statusKey: 'pending' },
  { key: 'deactivated', label: 'Deactivated', statusKey: 'deactivated' },
];
